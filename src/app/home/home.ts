...
export class Home {
  ...
  convertToLocalizationString() {
    ...
    this.localizationOutputCode = `static const String ${Helpers.toLocalizedString(this.localizationInputString, '_')} = '${Helpers.toLocalizedString(this.localizationInputString, '_')}';`;
    
    this.camelCaseOutput = Helpers.toCamelCase(this.localizationInputString);
    this.camelCaseCode = `static const String ${Helpers.toCamelCase(this.localizationInputString)} = '${Helpers.toLocalizedString(this.localizationInputString, '_')}';`;
  }
